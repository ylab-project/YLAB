function [gri, grj, grc, cri, crj, gsi, gsj, csi, csj, ...
  bnij, fcn, fbn, fsn, kcx, kcy, lamy, lamz, ...
  ration, bkinfo] = ...
  eval_nominal_allowable_stress_ratio(...
  mewfs, stn, stcn, A, Iy, Iz, C, ...
  mtype, stype, dir_girder, Em, Fm, idm2n, ...
  lb, lmn, lr, ...
  mejoint, nominal, isgmirrored, idmg2ng, ...
  idmc2nc, options, beta, lcdir, col_idstory)
...
[lkx, lky, kcx, kcy, bkinfo] = ...
  calc_buckling_length( ...
  Iy, mtype, idm2n1, idm2n2, dir_girder, ...
  lmn, lrm, lb, ...
