...
[idmc2sf1x_geo, idmc2sf2x_geo, ...
  idmc2sf1y_geo, idmc2sf2y_geo, ...
  idmc2mf1x_geo, idmc2mf2x_geo, ...
  idmc2mf1y_geo, idmc2mf2y_geo] = ...
  filter_column_face_girder_direction( ...
  node, member_girder, idmc2sf1x, idmc2sf2x, ...
...
if options.consider_allowable_stress_at_face
  ...
  [lf.columnx, lf.columny] = comp_face_length_column(...
    ...
    idmc2sf1x_geo, idmc2sf2x_geo, idmc2sf1y_geo, ...
    idmc2sf2y_geo, idmc2st, idmc2mf1x_geo, idmc2mf2x_geo, ...
    idmc2mf1y_geo, idmc2mf2y_geo, gcxl, gcyl, cz_std);
end
...
if options.consider_rigid_zone
  ...
  [lr.columnx, lr.columny] = calc_rigid_zone_column( ...
    ...
    idmc2mf1x_geo, idmc2mf2x_geo, idmc2mf1y_geo, ...
    idmc2mf2y_geo, idmc2st, idmg2sg, idsg2s, mcstype, ...
    idmc2s, cz_std);
  % 柱剛域（直接入力値で上書き）
