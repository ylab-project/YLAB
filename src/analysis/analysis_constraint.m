...
[msprop, secdim, dvec, dnode, felement, ...
  ...
  lf, lr, lm, lm_weight, lnm, lb, ...
  Iy, Iz, gphiI, gphiN, cphiI, ...
...
if coptions.consider_stress_ratio
  ...
  [gri, grj, grc, cri, crj, gsi, gsj, csi, csj, ...
    ...
    mtype, mstype, mgdir, Em, Fm, idm2n, ...
    lb, lm, lnm, lr, mejoint, nominal, ...
    isgmirrored, idmg2mng, idmc2mnc, ...
    options, beta, lcdir, idmc2st, ...
    com.member.column.onfg_x, ...
    com.member.column.onfg_y);
