function xvar = findNearestXvarofWfs(obj, repwfs, xvar0, ...
...
idH2var = idH2var(recalculate_variable(idH2var));
idB2var = idB2var(recalculate_variable(idB2var));
idtw2var = idtw2var(recalculate_variable(idtw2var));
idtf2var = idtf2var(recalculate_variable(idtf2var));
...
if isempty([idH2var idB2var idtw2var idtf2var])
  return
end
...
for idlist = 1:nlist
  ...
  twlist = standardAccessor.getStandardTw(idlist)';
  tflist = standardAccessor.getStandardTf(idlist)';
